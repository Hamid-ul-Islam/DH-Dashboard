        ...
        <div className="mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8 max-md:flex-col">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="mt-4 flex flex-col gap-4 sm:mt-0 sm:flex-row sm:items-center max-w-md">
              <Link
                href={"/products/new"}
                className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-indigo-600 px-5 py-3 text-indigo-600 transition hover:bg-indigo-50 hover:text-indigo-700 focus:outline-none focus:ring"
                type="button"
              >
                <svg
                  ...
                  <tr>
                    ...
                    <td className="whitespace-nowrap px-4 py-2 gap-4 flex">
                      <Link
                        ...
                        className="inline-block rounded bg-indigo-500 px-4 py-2 text-xs font-medium text-white hover:bg-indigo-700"
                      >
                        Edit
                      </Link>
                      <Link
